...
В течение трех дней с момента начала написания диплома вы должны сдать дипломному руководителю в личные сообщения в Discord план автоматизации, в котором описано:
