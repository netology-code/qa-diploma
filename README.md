...
1. Попробовать найти ответ сначала самому в интернете, и только после этого спрашивать дипломного руководителя. Именно скилл поиска ответов пригодится вам на первой работе.
...
Когда вы придёте на работу, то нужно делать так, как требует тот, кто ставит задачи. Естественно, это можно обсуждать, но ключевое - заранее привыкнуть к тому, что придётся подстраиваться под стиль работы команды и это (смена стиля) - не должно вызывать у вас дискомфорта. Вы должны быть к этому готовы. Постановщик задач в этом случае для вас — дипломный руководитель. Если дипломный руководитель просит что-то изменить, добавить или скорректировать, это нужно сделать несмотря на то, что домашние задания у вас принимались в том виде, в котором вы делаете сейчас. Это часть процесса обучения.
...
* а большинстве CI есть Docker и, возможно, даже Docker Compose.
