# Дипломный проект курса «Автоматизация тестирования»
...
*Важно: в реальной жизни приложение не должно через себя даже пропускать данные карт, если у него нет PCI DSS, но мы в сделали именно так 😈.*
